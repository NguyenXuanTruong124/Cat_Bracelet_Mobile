...
class PaymentService {
  ...
  Future<PaymentStatusModel> getStatus(
    ...
    final response = await http.get(
      Uri.parse(
        '$baseUrl/api/payment/status/$orderCode',
      ),
      headers: apiHeaders(),
    );

    debugPrint(
      'PAYMENT STATUS CODE: ${response.statusCode}',
    );

    debugPrint(
      'PAYMENT STATUS BODY: ${response.body}',
    );
  ...
  Future<Map<String, dynamic>> getInfo(
    ...
    final response = await http.get(
      Uri.parse(
        '$baseUrl/api/payment/info/$orderCode',
      ),
      headers: apiHeaders(),
    );
